...
uint64_t AttributesImpl::getAttrMask(uint64_t Val) {
  ...
  case Attributes::GENERATEDATTR:   return 1ULL << 34;
  case Attributes::TRANSFORMEDATTR:	return 1ULL << 35;
  case Attributes::NORMALARGATTR:	return 1ULL << 36;
  case Attributes::CHANNELWR:	    return 1ULL << 37;
  case Attributes::CHANNELRD:	    return 1ULL << 38;
  }
