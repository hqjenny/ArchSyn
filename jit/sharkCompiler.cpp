...
void SharkCompiler::printBitcode(){
  std::string ErrorInfo;
  OwningPtr<tool_output_file> Out
  (new tool_output_file( "out.txt", ErrorInfo,
  ...
  WriteBitcodeToFile(context()->module(), Out->os());
...
void SharkCompiler::init_llvm() {
  ...
  if (!execution_engine()) {
    ...
    //llvm::WriteBitcodeToFile(_native_context->module(), OS);
    //OS.flush();

    //LLVMWriteBitcodeToFile(_native_context->module(), "out.txt");
